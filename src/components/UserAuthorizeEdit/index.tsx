import { loadPrivilege } from '@/services/user';
...
const UserAuthorizeEdit: React.FC<EditType> = (props) => {
  ...
  return (
    ...
    >
      <ProFormField hidden={true} name="userId" />
...
export default UserAuthorizeEdit;
